...
/** BIOMETRIC_WEAK alone (not OR'd with BIOMETRIC_STRONG - that combination is invalid and some OEMs, e.g. Samsung One UI, reject it outright). WEAK accepts both weak- and strong-class sensors, which covers fingerprint on virtually every device. */
